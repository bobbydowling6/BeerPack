...
('Union Jack IPA', 'Firestone Walker Brewing Co.', 'IPA', 'American IPA', 2, '/images/IPA^s/firestoneipa.jpg'),
('Goose Island IPA', 'Goose Island Brewing Co.', 'IPA', 'English IPA', 2, '/images/IPA^s/gooseislandipa.jpg'),
('Lagunitas IPA', 'Lagunitas Brewing Co.', 'IPA', 'American IPA', 2, '/images/IPA^s/Lagunitas.jpg'),
('Samual Adams Rebel IPA', 'The Boston Beer Company', 'IPA', 'American IPA', 2, '/images/IPA^s/samualadamsipa.jpg'),
('Sierra Nevada Pale Ale', 'Sierra Nevada Brewing Co.', 'IPA', 'American Pale Ale', 2, '/images/IPA^s/sierranevada.jpg'),
('VooDoo Ranger IPA', 'New Belgium Brewing Co.', 'IPA', 'American IPA', 2, '/images/Ipa^s/voodoo-ranger-by-new-belgium-brewing-co.jpg'),
